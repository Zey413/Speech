...
import torch
import sys
sys.path.append('./tensorboardX')
#sys.path.append('./editdistance')
...
conf = yaml.load(open('F:\LasLocal\config\las_example_config.yaml','r'))
...
while global_step < total_steps:
    ...
    #
    # # Generate Attention map        去掉了variable.cuda()
    ...
    # else:
    #     feature = listener(Variable(batch_data.float()))
